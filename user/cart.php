...
<section class="shopping-cart">
   ...
   <table>
      ...
      <tbody>
         ...
         <tr>
            ...
            <td>
               <form action="" method="post">
                  ...
                  <input type="number" name="update_quantity" min="1" max="15" value="<?php echo $fetch_cart['quantity']; ?>" >
         ...
         <tr class="table-bottom">
            <td><a href="product.php" class="delete-btn" style="margin-top: 0;">continue shopping</a></td>
   ...
   <div class="checkout-btn">
      <a href="checkout.php" class="delete-btn <?= ($grand_total > 1)?'':'disabled'; ?>">procced to checkout</a>
   </div>
